...
let get_ledger (type a k v) (s:(a,k,v) t) = s.ledger
let set_ledger (type a k v) (s:(a,k,v) t) (ledger: (k,v) ledger) = {s with ledger = ledger}

let get_operators (type a k v) (s:(a,k,v) t) = s.operators
let set_operators (type a k v) (s:(a,k,v) t) (operators:Operators.t) = {s with operators = Some operators}

let get_approvals (type a k v) (s:(a,k,v) t) = s.approvals
let set_approvals (type a k v) (s:(a,k,v) t) (approvals:Approvals.t) = {s with approvals = approvals}
